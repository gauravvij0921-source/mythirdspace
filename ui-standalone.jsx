...
function M3SLogo({ size = 36, color = "currentColor" }) {
  ...
  // Resolve resource by id — at runtime after bundling, window.__resources is set
  // to a map of blob URLs. In source mode it's absent; fall back to the asset path.
  const R = (window.__resources || {});
  const src = R.logo || "assets/mts-logo.png";
  return (
