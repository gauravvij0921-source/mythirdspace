...
function TrainerProfile({ trainer, onClose, onBook }) {
  ...
  const V = "?v=15";
  const imgMap = { rahul: window.__resources.trainerRahul, joe: window.__resources.trainerJoe, aakash: window.__resources.trainerAakash, deepika: window.__resources.trainerDeepika, lee: window.__resources.trainerLee, deb: window.__resources.trainerDeb, tarun: window.__resources.trainerTarun, pilates: window.__resources.trainerAnisha, shahbaz: window.__resources.trainerShahbaz, santo: window.__resources.trainerSanto, shailaa: window.__resources.trainerShailaa };
        ...
        {TRAINERS.map(tr => (
          <button key={tr.id}
            ...
            <div style={{ aspectRatio: "3/4", borderRadius: "var(--r-lg)", overflow: "hidden", position: "relative",
              ...
              {(() => {
                const map = { rahul: window.__resources.trainerRahul, joe: window.__resources.trainerJoe, aakash: window.__resources.trainerAakash, deepika: window.__resources.trainerDeepika, lee: window.__resources.trainerLee, deb: window.__resources.trainerDeb, tarun: window.__resources.trainerTarun, pilates: window.__resources.trainerAnisha, shahbaz: window.__resources.trainerShahbaz, santo: window.__resources.trainerSanto, shailaa: window.__resources.trainerShailaa };
                const src = map[tr.id];
                return src
    ...
    <Section id="kenko" bg="var(--sand-50)">
      <div style={{
        ...
        <div style={{ borderRadius: "var(--r-lg)", overflow: "hidden", aspectRatio: "1/1" }}>
          <img src={window.__resources.kenkoBowls} alt="Kenko Life meal bowls" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
        </div>
      </div>
